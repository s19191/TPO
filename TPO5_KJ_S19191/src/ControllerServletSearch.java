...
@WebServlet("/search")
public class ControllerServletSearch extends HttpServlet {
    ...
    public void init() {
        ...
        presentationServ = context.getInitParameter("presentationServletSearch");
        getParamsServ = context.getInitParameter("getParamsServletSearch");
        String commandClassName = context.getInitParameter("commandSearchClassName");
