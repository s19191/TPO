...
@WebServlet("/allBooks")
public class ControllerServletAllBooks extends HttpServlet {
    ...
    public void init() {
        ...
        presentationServ = context.getInitParameter("presentationServletAllBooks");
        getParamsServ = context.getInitParameter("getParamsServletAllBooks");
        String commandClassName = context.getInitParameter("commandAllBooksClassName");
