...
@WebServlet("/resBundleSearch")
public class ResourceBundleServletSearch extends HttpServlet {

    private String resBundleName;

    public void init() {
        resBundleName = getServletContext().getInitParameter("resBundleSearchName");
    }
