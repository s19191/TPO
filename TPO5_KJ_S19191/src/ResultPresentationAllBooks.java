...
@WebServlet("/presentationAllBooks")
public class ResultPresentationAllBooks extends HttpServlet {
    ...
    public void serviceRequest(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        // (formularz)
        String getParamsServ = context.getInitParameter("getParamsServletAllBooks");
