...
@WebServlet("/presentationSearch")
public class ResultPresentationSearch extends HttpServlet {
    ...
    public void serviceRequest(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        // (formularz)
        String getParamsServ = context.getInitParameter("getParamsServletSearch");
