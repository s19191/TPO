...
@WebServlet("/resBundleAllBooks")
public class ResourceBundleServletAllBooks extends HttpServlet {

    private String resBundleName;

    public void init() {
        resBundleName = getServletContext().getInitParameter("resBundleAllBooksName");
    }
